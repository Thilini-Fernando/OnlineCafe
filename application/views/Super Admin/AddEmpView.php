<?php include 'HnF/header.php' ?>
	...
	<div class="container col-lg-12" align="center" style="text-align: center;">
		...
		<?php echo form_open('SuperAdminCont/regEmp'); ?>
			...
			<div class="container col-lg-12" align="right" style="text-align: left;">
				...
				<div class="row col-lg-12">
					...
					<div class="form-group col-lg-6">
					    ...
					    <input type="date" class="form-control" min="1968-01-01" placeholder="19XX-xx-xx" name="dob">
					</div>
				</div>
				...
				<div class="row col-lg-12">
					...
					<div class="form-group col-lg-6">
					    ...
					    <input type="text" class="form-control" placeholder="07X-XXXXXXX" maxlength="10" minlength="10" name="cntct">
					</div>
					
					<div class="form-group col-lg-6">
					    <label>Email address</label>
					    <input type="email" class="form-control" placeholder="__@email.com" name="eml">
					</div>
				</div>
