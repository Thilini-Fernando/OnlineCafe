<?php include 'HnF/header.php' ?>
	...
	<div class="container" style="color: whitesmoke" >
		<br>
		<center>
			<h1><b>Super Admin Login Form</b></h1>
		...
		<?php echo form_open('HomeCont/logSAdmin'); ?>
			...
			<div class="container">
				...
				<div class="container col-sm-5 col-sm-offset-3" style="background-color: black">
					...
					<div class="form-group">
					    <label for="exampleInputPassword1"><b>Super Admin key</b></label>
					    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Super key" name="sadmnk">
					</div>
