	...
	<!--  Charts Plugin -->
	<script src="<?php echo base_url("assets/Admin_assets/js/chartist.min.js"); ?>"></script>

    <!--  Notifications Plugin    -->
    <script src="<?php echo base_url("assets/Admin_assets/js/bootstrap-notify.js"); ?> "></script>

    <!--  Google Maps Plugin    -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>

    <!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
	<script src="<?php echo base_url("assets/Admin_assets/js/light-bootstrap-dashboard.js?v=1.4.0"); ?>"></script>
