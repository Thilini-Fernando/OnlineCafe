...
<head>
    ...
    <link href="assets/Admin_assets/css/pe-icon-7-stroke.css" rel="stylesheet" />
...
-->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="<?php echo base_url("index.php/CustomerCont/viewFoodItems"); ?>">
                ...
                <li>
                    <a href="<?php echo base_url("index.php/CustomerCont/orderNow");?>"
                        <i class="pe-7s-call"></i>
                        <p>Order Now</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url("index.php/CustomerCont/orderLater");?>"
